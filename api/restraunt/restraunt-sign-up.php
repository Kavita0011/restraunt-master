...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $isInserted = insertRecord($conn, 'restaurants', $userData);
...
<body>
    <div class="login-container">
        ...
        <p class="signup-text">Already have an account? <a href="restraunt-login.php">Sign in</a></p>
    </div>
</body>
</html>
